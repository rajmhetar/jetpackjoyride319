...
//        b blue value
// Output: 16-bit color
// Notes: Adafruit uses a BGR color order and HiLetGo uses RGB
//        but we took care of their differences when we set the 
//        model used as part of the MADCTL setting 00:RGB; 08:BGR 
